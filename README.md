...
If you want to test the pretained mdoel, pealse download the weights from the link above, and move it to the checkpoint folder (create one if you don't have). The evaluation scripts also has been provided in script/train.sh
